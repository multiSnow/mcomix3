...
FILES = (('src/about_dialog.py', 'share/mcomix/src'),
        ...
        ('src/about_dialog.pyc', 'share/mcomix/src'),
        ('src/archive_extractor.pyc', 'share/mcomix/src'),
        ('src/archive_packer.pyc', 'share/mcomix/src'),
        ('src/archive_tools.pyc', 'share/mcomix/src'),
        ('src/bookmark_backend.pyc', 'share/mcomix/src'),
        ('src/bookmark_dialog.pyc', 'share/mcomix/src'),
        ('src/bookmark_menu_item.pyc', 'share/mcomix/src'),
        ('src/bookmark_menu.pyc', 'share/mcomix/src'),
        ('src/clipboard.pyc', 'share/mcomix/src'),
        ('src/comment_dialog.pyc', 'share/mcomix/src'),
        ('src/constants.pyc', 'share/mcomix/src'),
        ('src/cursor_handler.pyc', 'share/mcomix/src'),
        ('src/deprecated.pyc', 'share/mcomix/src'),
        ('src/dialog_handler.pyc', 'share/mcomix/src'),
        ('src/edit_comment_area.pyc', 'share/mcomix/src'),
        ('src/edit_dialog.pyc', 'share/mcomix/src'),
        ('src/edit_image_area.pyc', 'share/mcomix/src'),
        ('src/encoding.pyc', 'share/mcomix/src'),
        ('src/enhance_backend.pyc', 'share/mcomix/src'),
        ('src/enhance_dialog.pyc', 'share/mcomix/src'),
        ('src/event.pyc', 'share/mcomix/src'),
        ('src/file_chooser_base_dialog.pyc', 'share/mcomix/src'),
        ('src/file_chooser_library_dialog.pyc', 'share/mcomix/src'),
        ('src/file_chooser_main_dialog.pyc', 'share/mcomix/src'),
        ('src/file_chooser_simple_dialog.pyc', 'share/mcomix/src'),
        ('src/file_handler.pyc', 'share/mcomix/src'),
        ('src/histogram.pyc', 'share/mcomix/src'),
        ('src/icons.pyc', 'share/mcomix/src'),
        ('src/image_handler.pyc', 'share/mcomix/src'),
        ('src/image_tools.pyc', 'share/mcomix/src'),
        ('src/labels.pyc', 'share/mcomix/src'),
        ('src/lens.pyc', 'share/mcomix/src'),
        ('src/library_add_progress_dialog.pyc', 'share/mcomix/src'),
        ('src/library_backend.pyc', 'share/mcomix/src'),
        ('src/library_book_area.pyc', 'share/mcomix/src'),
        ('src/library_collection_area.pyc', 'share/mcomix/src'),
        ('src/library_control_area.pyc', 'share/mcomix/src'),
        ('src/library_main_dialog.pyc', 'share/mcomix/src'),
        ('src/main.pyc', 'share/mcomix/src'),
        ('src/pageselect.pyc', 'share/mcomix/src'),
        ('src/preferences_dialog.pyc', 'share/mcomix/src'),
        ('src/preferences_page.pyc', 'share/mcomix/src'),
        ('src/preferences.pyc', 'share/mcomix/src'),
        ('src/preferences_section.pyc', 'share/mcomix/src'),
        ('src/process.pyc', 'share/mcomix/src'),
        ('src/properties_dialog.pyc', 'share/mcomix/src'),
        ('src/properties_page.pyc', 'share/mcomix/src'),
        ('src/recent.pyc', 'share/mcomix/src'),
        ('src/slideshow.pyc', 'share/mcomix/src'),
        ('src/status.pyc', 'share/mcomix/src'),
        ('src/thumbbar.pyc', 'share/mcomix/src'),
        ('src/thumbnail_tools.pyc', 'share/mcomix/src'),
        ('src/tools.pyc', 'share/mcomix/src'),
        ('src/ui.pyc', 'share/mcomix/src'),
